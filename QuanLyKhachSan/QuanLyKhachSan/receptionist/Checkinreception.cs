    ...
    public partial class Checkinreception : Form
    {
        ...
        private void buttonshow_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                int day = selected_date.Day;
                string date = $"{year}-{month}-{day}";
                SqlCommand command = new SqlCommand("SELECT Timekeeping_id,Timekeeping_employee,date,timein,timeout,employee_name,role FROM Timekeeping,employees WHERE  date = @date and role ='Receptionist' and Timekeeping_employee = employee_id");
